                        ...
                        <div class="card wizard-card" data-color="red" id="wizard">
                            <form action="addacount.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="wizard-navigation">
                                    <ul>
                                        <li><a href="#description" data-toggle="tab">基本資料</a></li>
                                        <li><a href="#details" data-toggle="tab">設定</a></li>
                                        <li><a href="#captain" data-toggle="tab">興趣</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <div class="choice" data-toggle="wizard-radio" rel="tooltip"
                                                            title="">
                                                            <input name="telephone_number" type="text" class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-group label-floating">
                                                        <label class="control-label">用戶暱稱</label>
                                                ...
                                                <div style="margin-left: 15px;">
                                                    <label for="user_avatar" class="custom-file-upload">上傳頭貼</label>
                                                ...
                                                <script>
                                                    document.getElementById('user_avatar').onchange = function (e) {
                                                        ...
                                                        reader.onload = function (event) {
                                                            ...
                                                            img.src = event.target.result; // 設置圖片源
                                                            img.style.maxWidth = '200px'; // 設置圖片最大寬度
                                                            document.getElementById('imagePreview').innerHTML = ''; // 清空預覽區域
                                                            document.getElementById('imagePreview').appendChild(img); // 添加圖片到預覽區域
                                                        };
                                    ...
                                    <div class="tab-pane" id="captain">
                                        <h4 class="info-text"> <b>選擇您的感興趣的主題（可複選）</b></h4>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="choice" data-toggle="wizard-checkbox" rel="tooltip"
                                                    title="">
                                                    <input type="checkbox" name="job[]" value="clothes">
                                                    <div class="icon">
                                                ...
                                                <div class="choice" data-toggle="wizard-checkbox" rel="tooltip"
                                                    title="">
                                                    <input type="checkbox" name="job[]" value="makeup">
                                                    <div class="icon">
                                                ...
                                                <div class="choice" data-toggle="wizard-checkbox" rel="tooltip"
                                                    title="">
                                                    <input type="checkbox" name="job[]" value="annime">
                                                    <div class="icon">
                                            ...
                                            <div class="col-md-4">
                                                <div class="choice" data-toggle="wizard-checkbox" rel="tooltip"
                                                    title="">
                                                    <input type="checkbox" name="job[]" value="star">
                                                    <div class="icon">
                                                ...
                                                <div class="choice" data-toggle="wizard-checkbox" rel="tooltip"
                                                    title="">
                                                    <input type="checkbox" name="job[]" value="daily">
                                                    <div class="icon">
                                                ...
                                                <div class="choice" data-toggle="wizard-checkbox" rel="tooltip"
                                                    title="">
                                                    <input type="checkbox" name="job[]" value="3c">
                                                    <div class="icon">
                                            ...
                                            <div class="col-md-4">
                                                <div class="choice" data-toggle="wizard-checkbox" rel="tooltip"
                                                    title="">
                                                    <input type="checkbox" name="job[]" value="food">
                                                    <div class="icon">
                                                ...
                                                <div class="choice" data-toggle="wizard-checkbox" rel="tooltip"
                                                    title="">
                                                    <input type="checkbox" name="job[]" value="sport">
                                                    <div class="icon">
                                                ...
                                                <div class="choice" data-toggle="wizard-checkbox" rel="tooltip"
                                                    title="">
                                                    <input type="checkbox" name="job[]" value="gift">
                                                    <div class="icon">
