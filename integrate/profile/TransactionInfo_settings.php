        ...
        <header id="header2" class="d-flex flex-column justify-content-center">
          <nav id="navbar2" class="navbar2 nav-menu2">
            <ul>
              ...
              <li><a href="./TransactionInfo_settings.html" class="nav-link scrollto active"><i class="fa-solid fa-credit-card"></i><span>交易資訊設定</span></a>
              </li>
              <li><a href="./Wishlist.html" class="nav-link scrollto"><i class="fa-solid fa-heart"></i><span>收藏清單</span></a></li>
