    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <div class="d-flex justify-content-between align-items-center">
          <ol>
            <li><a href="wish.html">許願區</a></li>
            <li>許願詳情</li>
          </ol>
          <button class="button-cancel">取消許願</button>
        </div>
      </div>
            ...
            <section id="portfolio-details" class="portfolio-details"> 
              <div class="container" data-aos="fade-up">    
                <div class="portfolio-info">
                  <div class="portfolio-details-title flex-container">
                    <h3>許願資訊</h3><button type="button" class="btn insert_button">我有興趣</button>
                  </div>
                  <br>
                  <ul>
                    <li><strong><i class="bi bi-person"></i>&nbsp;許願者</strong>: <a href="#"><img src="https://i.pinimg.com/564x/34/16/1d/34161d9ecd3d64f087e4d5cd1a319dd5.jpg" style="width:20px;height:20px; border-radius: 10px;" alt="">&nbsp;杏花麻麻</a></li>
                    <li><strong><i class="bi bi-clock"></i>&nbsp;許願日期</strong>: 2024-04-02</li>
                    <li><strong><i class="bi bi-heart heart-icon"></i>&nbsp;我有興趣人數</strong>: &nbsp;65&nbsp;</li>
                    <li><strong><i class="bi bi-chat-dots"></i>&nbsp;敘述</strong>: </li>
                      <p class="scrollable-row">想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款想收圖上的的大娃，有拆封過也沒關係，可先匯款</p>
                  </ul>
                </div>              
              </div>
            </section>  
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="member d-flex align-items-start">
            <div class="pic"><img src="https://img.ws.mms.shopee.tw/tw-11134211-7qukx-li51ahq6fgz8d8" class="img-fluid" alt=""></div>
            <div class="member-info">
              <h4>排球少年日本代購</h4>
              <div class="flex-container">
                <span><i class="fa-regular fa-clock"></i>&nbsp;2024-04-04</span>
                <a href="#" class="reply"><i class="bi bi-link"></i> 賣場連結</a>
              </div>
              <table>
                <tr>
                  ...
                  <td style="text-align: right;">15&nbsp;</span></td>
                </tr>
                <tr>
        ...
        <div class="col-lg-6">
          <div class="member d-flex align-items-start">
            <div class="pic"><img src="https://i.pinimg.com/564x/1f/c6/6a/1fc66a08447b965a3e1000ccfc784029.jpg" class="img-fluid" alt=""></div>
            <div class="member-info">
              <h4>排球少年日本代購</h4>
              <div class="flex-container">
                <span><i class="fa-regular fa-clock"></i>&nbsp;2024-04-04</span>
              ...
              <table>
                ...
                <tr>
                  ...
                  <td style="text-align: right;">10&nbsp;</td>
                  <td><i class="fa-solid fa-face-smile"></i>&nbsp;狀態:</td>
                  <td style="color: rgb(195, 123, 123);text-align: right;">待成團</td>
                </tr>
                <tr>
                  <td colspan="4">
                    <button type="button" class="btn insert_button" style="display: block;width: 100%;">我要跟團</button>
