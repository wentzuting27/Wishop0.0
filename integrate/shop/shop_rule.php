 ...
 <header id="header" class="fixed-top d-flex align-items-center">
  ...
  if(isset($_SESSION["account"])){
    if(mysqli_num_rows($result_likeshop)==0){
      echo '<a href="like_in_de.php?shop_id=',$shop_id,'&page=shop_rule&method=in&like=shop"><button type="button" class="btn insert_button"><i class="fa-regular fa-heart"></i>&nbsp;收藏賣場</button></a>';
    }else{
      echo '<a href="like_in_de.php?shop_id=',$shop_id,'&page=shop_rule&method=de&like=shop"><button type="button" class="btn delike_button"><i class="fa-solid fa-heart"></i>&nbsp;取消收藏</button></a>';
    }
  }
  echo '
              ...
              <section id="schedule" class="section-with-bg">
                ...
                <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <form method="post" action="social_in_up_de.php" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="page" class="form-control" style="width: 100%;" value="shop_rule">
                  ...
                  <div role="tabpanel" class="col-lg-12  tab-pane fade" id="social_de">
                    ...
                    <?php
                        ...
                        <tr>
                          ...
                          <td width="10%"><a href="social_in_up_de.php?social_id=',$row_social["social_id"],'&page=shop_rule" class="nav-link scrollto"><i class="fa-solid fa-xmark"></i></a></td>
                        </tr>';
                        }
                        ?>
